...
if (!defined('EH_STRIPE_VERSION')) {
    define('EH_STRIPE_VERSION', '3.5.6');
}
...
if(is_plugin_active('eh-stripe-payment-gateway/stripe-payment-gateway.php')){ 
    ...
    function eh_stripe_plugin_action_links($links) {
        ...
        $plugin_links = array(
            ...
            '<a href="https://www.webtoffee.com/product/woocommerce-stripe-payment-gateway/?utm_source=free_plugin_sidebar&utm_medium=Stripe_basic&utm_campaign=Stripe&utm_content='.EH_STRIPE_VERSION.'" target="_blank">' . __('Premium Upgrade', 'payment-gateway-stripe-and-woocommerce-integration') . '</a>',
