...
class EH_Alipay_Stripe_Gateway extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_description = sprintf( __( 'Accept payments using Alipay. Stripe account credentials should be entered <a href="%s" >here</a>.', 'payment-gateway-stripe-and-woocommerce-integration' ), admin_url( 'admin.php?page=wt_stripe_menu' ) );
		$this->supports           = array(
			'products',
			'refunds',
		);
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			'enabled'                       => array(
				...
				'label'       => __('Enable Stripe Alipay Payment','payment-gateway-stripe-and-woocommerce-integration'),
				'type'        => 'checkbox',
				'default'     => isset($stripe_settings['eh_stripe_alipay']) ? $stripe_settings['eh_stripe_alipay'] : 'no',
				'desc_tip'    => __('Enable this option to have an Alipay payment option in your checkout.','payment-gateway-stripe-and-woocommerce-integration'),
			),
			'eh_stripe_alipay_title'         => array(
				'title'       => __('Title','payment-gateway-stripe-and-woocommerce-integration'),
				'type'        => 'text',
				'description' =>  __('The texts entered in this field will be displayed as the title for the AliPay payment at the checkout.', 'payment-gateway-stripe-and-woocommerce-integration'),
			...
			'eh_stripe_alipay_description'     => array(
				...
				'type'        => 'textarea',
				'css'         => 'width:25em',
				'description' => __('The texts entered in this field will be displayed as a short description for the AliPay payment at the checkout.', 'payment-gateway-stripe-and-woocommerce-integration'),
