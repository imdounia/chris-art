...
class EH_Stripe_Payment extends WC_Payment_Gateway {
    ...
    public function __construct() {
        ...
        $this->method_title = __('Stripe Payment', 'payment-gateway-stripe-and-woocommerce-integration');
        ...
        $this->method_description = sprintf(__("Accept credit card payments directly on your website via WebToffee Stripe payment gateway.", 'payment-gateway-stripe-and-woocommerce-integration'));
